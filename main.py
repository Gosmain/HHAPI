...
def get_text_messages(message):
  ...
  if message.text.lower() == "получить вакансии":
    ...
    with open('req.txt', 'w', encoding='utf-8') as r, open('vacancies.txt', 'w', encoding='utf-8') as v:
    ...
    bot.send_message(message.from_user.id, "Напишите 'получить вакансии' или 'обновить вакансии'")
